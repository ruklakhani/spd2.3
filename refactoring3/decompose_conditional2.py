...
def good_cholostrol(total_cholostrol, ldl, triglyceride):
    return total_cholostrol < 200 and ldl < 100 and triglyceride < 150

def high_cholostrol(total_cholostrol, ldl, triglyceride):
...
if good_cholostrol(total_cholostrol, ldl, triglyceride):
    # good level
    print('*** Good level of cholestrol ***')
elif high_cholostrol(total_cholostrol, ldl, triglyceride):
